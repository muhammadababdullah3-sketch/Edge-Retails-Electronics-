...
Important: The complete architecture below includes the original architecture, forensic corrections, shop-holder operational additions, and the authoritative Sales/Purchasing/Concurrency/Cloud addendum through Section 169.

Physical implementation status must be verified separately. Architecture FINAL does not automatically mean every physical module is already production-complete.
