...
public sealed class ShellViewModel : ViewModelBase, IDisposable
{
        ...
        Action? switchUser = null)
    {
        ...
        var navigationItems = new List<NavigationItemViewModel>
        {
            ...
            CreateNavigationItem("Product Management", NavigationTarget.ProductManagement, "Icon.Nav.ProductManagement"),
            ...
            CreateNavigationItem("Warranty", NavigationTarget.Warranty, "Icon.Nav.Warranty"),
